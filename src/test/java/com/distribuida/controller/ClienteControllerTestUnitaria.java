...
public class ClienteControllerTestUnitaria {
    ...
    public void  setUp(){
        ...
        cliente.setCedula("1719439271");
        cliente.setNombre("Perico");
        cliente.setApellido("De los palotes");
        cliente.setDireccion("Lejos de  aqui");
        cliente.setTelefono("0943029547");
        cliente.setCorreo("perico.delospalores@delospalotes");
    }
    @Test
    ...
    public void testSave(){
        ...
        assertEquals(200, respuesta.getStatusCodeValue());
        assertEquals("Perico", respuesta.getBody().getNombre());
    }
    @Test
