...
public class FacturaControllerTestUnitaria {
    ...
    public void  setUp(){
        ...
        factura.setNumFactura("FAC-001233");
        factura.setFecha(new Date());
        factura.setTotalNeto(143.22);
        factura.setIva(51.22);
        factura.setTotal(194.44);
    }
    ...
    public void testSave(){
        ...
        assertEquals(200, respuesta.getStatusCodeValue());
        assertEquals("FAC-001233", respuesta.getBody().getNumFactura());
    }
    @Test
